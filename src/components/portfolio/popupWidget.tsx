                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          className={`w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-black placeholder:text-gray-300 focus:outline-none focus:ring   ${
                            errors.name
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          className={`h-28 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-black placeholder:text-gray-300 focus:outline-none focus:ring   ${
                            errors.message
                              ? 'border-red-600 ring-red-100 focus:border-red-600'
                              : 'border-gray-300 ring-indigo-100 focus:border-indigo-600'
                          }`}
