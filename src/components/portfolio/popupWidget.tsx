          ...
          <>
            ...
            >
              <Disclosure.Panel className='  left-0 flex  max-h-full min-h-[200px] w-3/4 flex-col overflow-hidden rounded-md  border-black bg-white shadow-2xl  sm:h-[600px] sm:max-h-[calc(100vh-120px)] sm:w-[350px]'>
                ...
                <div className='bg-gray-50 h-full grow overflow-auto p-6 '>
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className='mb-4'>
                        ...
                        <input
                          ...
                          className={`border-gray-300 placeholder:text-gray-300 w-full rounded-md border bg-white px-3 py-2 text-black focus:outline-none focus:ring   ${
                            errors.name
                      ...
                      <div className='mb-4'>
                        ...
                        <textarea
                          ...
                          className={`border-gray-300 placeholder:text-gray-300 h-28 w-full rounded-md border bg-white px-3 py-2 text-black focus:outline-none focus:ring   ${
                            errors.message
                              ? 'border-red-600 ring-red-100 focus:border-red-600'
                              : 'border-gray-300 ring-indigo-100 focus:border-indigo-600'
                          }`}
                      ...
                      <div className='mb-3'>
                        <button
                          type='submit'
                          className='w-full rounded-md bg-[#121212] px-3 py-4 text-white focus:bg-slate-600 focus:outline-none'
                        >
                          {isSubmitting ? (
                            <svg
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <>
                      <div className='flex h-full flex-col items-center justify-center rounded-md text-center text-white'>
                        ...
                        <h3 className='text-green-500 py-5 text-xl'>
