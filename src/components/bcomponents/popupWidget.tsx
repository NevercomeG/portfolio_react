  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className='ease fixed right-5 bottom-8 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-slate-600 shadow-lg transition duration-300 hover:bg-slate-800 focus:bg-slate-800 focus:outline-none'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className='mb-4'>
                        ...
                        <textarea
                          ...
                          className={`h-28 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-black placeholder-gray-300 focus:outline-none focus:ring   ${
                            errors.message
                              ? 'border-red-600 ring-red-100 focus:border-red-600'
                              : 'border-gray-300 ring-indigo-100 focus:border-indigo-600'
                          }`}
