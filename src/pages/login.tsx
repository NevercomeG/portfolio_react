              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate>
                ...
                <div className='data-te-input-wrapper-init relative mb-6'>
                  ...
                  <input
                    ...
                    className={`peer block min-h-[auto] w-full rounded border-0 bg-white bg-transparent py-[0.32rem] px-3 leading-[2.15] text-black outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none   [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0  ${
                      errors.username
                ...
                <div className='data-te-input-wrapper-ini relative mb-6'>
                  ...
                  <input
                    ...
                    className={`peer block min-h-[auto] w-full rounded border-0 bg-white bg-transparent py-[0.32rem] px-3 leading-[2.15] text-black    ${
                      errors.password
                        ? 'border-red-600 ring-red-100 focus:border-red-600'
                        : 'border-gray-300 ring-indigo-100 focus:border-indigo-600'
                    }`}
                ...
                <a
                  className='mb-3 flex w-full items-center justify-center rounded bg-white px-7 pt-3 pb-2.5 text-center text-sm font-medium uppercase leading-normal text-black shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:text-white hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]'
