      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full rounded border border-gray-300 px-3 py-2 leading-tight text-gray-700 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
            required
          />
        </div>
        <div className="mb-4">
